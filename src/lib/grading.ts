...
export const gradeRules = [
  { grade: 5, minJobs: 100, minRating: 4.7, minOnTime: 95, maxCancellation: 5, maxLostDisputes: 3, capacity: 20 },
  { grade: 4, minJobs: 50, minRating: 4.5, minOnTime: 90, maxCancellation: 7, maxLostDisputes: 5, capacity: 12 },
  { grade: 3, minJobs: 20, minRating: 4.2, minOnTime: 85, maxCancellation: 10, maxLostDisputes: 7, capacity: 7 },
  { grade: 2, minJobs: 5, minRating: 4.0, minOnTime: 80, maxCancellation: 15, maxLostDisputes: 10, capacity: 4 },
] as const;
