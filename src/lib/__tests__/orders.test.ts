...
describe("order workflow",()=>{
  it("allows valid forward transitions",()=>{expect(canTransitionOrder("pending_deposit","active")).toBe(true);expect(canTransitionOrder("delivered","completed")).toBe(true)});
