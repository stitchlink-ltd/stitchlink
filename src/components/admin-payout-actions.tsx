...
import { recordPayout } from "@/app/marketplace/actions";
...
export function AdminPayoutActions({ payoutId }: { payoutId: string }) {
  ...
  function record() {
    ...
    startTransition(async () => {
      const result = await recordPayout(payoutId, reference.trim());
    ...
    return (
      <div className="w-full space-y-2 sm:w-64">
        <input
          ...
          placeholder="Provider reference (bank/Paystack transfer ID)…"
