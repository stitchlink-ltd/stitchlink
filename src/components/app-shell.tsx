...
import { CalendarDays, ChevronDown, CircleDollarSign, ClipboardCheck, FolderOpen, Gauge, Images, LayoutDashboard, LogOut, Menu, MessageCircle, Ruler, Scale, Scissors, Settings, ShieldCheck, Sparkles, Users, WalletCards, X } from "lucide-react";
...
export function AppShell({ children, role, identity, demo = false }: { children: React.ReactNode; role: Role; identity: Identity; demo?: boolean }) {
  ...
  return <div className="min-h-screen overflow-x-hidden bg-background lg:grid lg:grid-cols-[260px_1fr]">
    <aside className="fixed inset-y-0 left-0 z-10 flex w-[280px] flex-col bg-ink p-5 text-white lg:sticky lg:top-0 lg:z-auto lg:h-screen lg:w-auto">
