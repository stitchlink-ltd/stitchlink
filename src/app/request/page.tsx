...
export default async function RequestPage({ searchParams }: PageProps<"/request">) {
  ...
  return <PublicShell><section className="paper-grid bg-[#eee6da] px-4 py-12 sm:py-16"><RequestWizard initialTailor={typeof tailor === "string" ? tailor : undefined} tailors={tailors} /></section></PublicShell>;
}
